...
// Campaign Routes
router.get('/getAllCampaigns', authenticateToken, CampaignController.getAllCampaigns); // Get All Campaigns
router.get('/getDonatedCampaigns', authenticateToken, CampaignController.getDonatedCampaigns); // Get Donated Campaigns
